...
package andre.usjt.br.lifecycle.util;
...
public class Utils {
    ...
    private static andre.usjt.br.lifecycle.util.StatusTracker mStatusTracker = andre.usjt.br.lifecycle.util.StatusTracker.getInstance();
